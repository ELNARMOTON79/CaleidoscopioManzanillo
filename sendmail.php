...
$mail = new PHPMailer(true);
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('rafaelalex6949@gmail.com', 'Support Colima Quest Tours');
        $mail->addAddress('rafaelalexandro6949@gmail.com');     //Add a recipient
    
        //Content
        $mail->isHTML(true);                                  //Set email format to HTML
        $mail->Subject = 'Support Colima Quest Tours';
        ...
        $htmlContent = <<<HTML
            ...
            <div class="container">
                ...
                <h1>Support Colima Quest Tours</h1>
                </div>
                <div class="main-content">
                <h2>Support</h2>
                <p>Name: $nombre<br>Email: $email<br>Message: $mensaje</p>
                </div>
                <div class="footer">
